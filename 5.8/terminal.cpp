...
void Terminal::help() {
    ...
    cout << "  --port     "
            "指定服务器端口，紧跟<port>为端口号，仅在使用--server时有效"
         << endl;
...
void Terminal::run() {
    ...
    while (true) {
        ...
        case 1: // search
            ...
            cin >> b;
            getchar();
            cout << "请选择出行方式: 0.火车 1.飞机: ";
            route_type = rangeInput(0, 1);
            cout << "请选择策略: 0.最小花费 1.最短时间 2.最少换乘: ";
            policy = rangeInput(0, 2);
            CLS;
...
void Terminal::printMenu() {
    if (admin) {
        ...
        cout << "3. 显示火车车次" << endl;
        cout << "4. 显示飞机航班" << endl;
        cout << "8. 切换搜索算法\t当前算法：" << (algorithm == ALGO_DP ? "动态规划" : "Dijkstra")
             << endl;
        cout << "9. 进入管理模式" << endl;
        cout << "0. 退出" << endl;
        cout << endl;
